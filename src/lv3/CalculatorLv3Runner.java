...
public class CalculatorLv3Runner {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // 연산자를 기준으로 수 나누기
            Number number1 = CalculatorLv3.parseNumber(formula.substring(0, operIdx)); // 첫 번째 수 입력
            Number number2 = CalculatorLv3.parseNumber(formula.substring(operIdx+1)); // 두 번째 수 입력
